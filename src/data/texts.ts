...
export const rawTexts = {
  ...
  tests: {
    ...
    seeExplanations: { en: 'See Explanations 📖', ta: 'விடைவிளக்கங்கள் காண்க 📖' },
    hideExplanations: { en: 'Hide Explanations 📖', ta: 'விடைவிளக்கங்களை மறை 📖' },
    todaysQuiz: { en: "Today's Quiz ⚡", ta: 'இன்றைய தேர்வு ⚡' },
    completedForToday: { en: 'completed for today ✅', ta: 'இன்றைய தேர்வு முடிந்தது ✅' },
    startScheduledQuiz: { en: 'start test →', ta: 'தேர்வு தொடங்கு →' },
  },
  news: {
