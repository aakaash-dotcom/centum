  ...
  return (
    <div className="flex-1 flex flex-col px-4 pt-4 pb-8 animate-fade-in">
      ...
      <div className="space-y-4">
        {/* Promise Highlight */}
        <div className="bg-[#A3E635]/20 dark:bg-[#A3E635]/10 border border-[#A3E635] rounded-3xl p-5 flex items-start gap-3.5">
          <div className="p-2.5 rounded-2xl bg-[#A3E635] text-[#18181B] shrink-0 mt-0.5">
            <HeartHandshake className="w-5 h-5" />
          </div>
          <div>
            <h2 className="text-base font-black text-[#18181B] dark:text-[#FAF5FF] mb-1">
              Student Promise
            </h2>
            <p className="text-sm font-extrabold text-[#2E1065] dark:text-[#A3E635]">
        ...
        <div className="bg-white dark:bg-[#3B0F6E] rounded-3xl p-5 border border-[#EDE9FE] dark:border-[#DDD6FE]/20 shadow-xs">
          <div className="flex items-center gap-2 mb-2">
            <ShieldCheck className="w-5 h-5 text-[#16A34A] dark:text-[#4ADE80]" />
            <h2 className="text-sm font-black text-[#2E1065] dark:text-[#FAF5FF]">
              {texts.privacy.section1Title}
            </h2>
          </div>
          <p className="text-xs font-semibold text-[#6D28D9]/80 dark:text-[#DDD6FE]/80 leading-relaxed">
        ...
        <div className="bg-white dark:bg-[#3B0F6E] rounded-3xl p-5 border border-[#EDE9FE] dark:border-[#DDD6FE]/20 shadow-xs">
          <div className="flex items-center gap-2 mb-2">
            <FileCheck2 className="w-5 h-5 text-[#7C3AED] dark:text-[#A3E635]" />
            <h2 className="text-sm font-black text-[#2E1065] dark:text-[#FAF5FF]">
        ...
        <div className="text-center pt-6">
          <p className="text-xs font-bold text-[#6D28D9]/60 dark:text-[#DDD6FE]/60">
